...
# Liste de 20 questions sous forme de dictionnaires
questions = [
    {
...
# Création d'un formulaire pour grouper toutes les questions
with st.form("quiz_form"):
    ...
    for i, q in enumerate(questions):
        ...
        if "image" in q:
            st.image(q["image"], caption="Illustration", use_column_width=True)
        # Stockage de la réponse de l'utilisateur
